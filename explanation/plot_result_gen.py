...
def plot_result(data_dir, clique, adj_file, filename, E_file, segfile, save_dir, savefile, thres, ym, xm):
    """
...
if __name__ == '__main__':
    ...
    xm=300
    #hurricane= 'Harvey'
    plot_result(data_dir, clique, adj_file, filename, E_file, segfile, save_dir, savefile, thres, ym,xm)
