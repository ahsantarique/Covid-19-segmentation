...
function [] = demo_regions_seg_exog3_fast(resultsoutputdir,inputfile,visfile,laplacefile,k,segLimit,lam1,lam2,lam3,beta,nbclustersV,nbclustersU)
			    ...
			    for lambda_2=lam2
                    for lambda_3=lam3
                        for beta_1=beta
                            ...
                            %fV=1;
                            if fV & size(segmentindicesV,2)<segLimit
